...
void Runnable::switchScreenMode()
{
	...
	if(md3dPP.Windowed)
	{
		...
		SetWindowLongPtr(mhMainWindow, GWL_STYLE, WS_POPUP);
...
void Runnable::drawAll()
{
	...
	HR(gd3dDevice->Clear(0, 0, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER | D3DCLEAR_STENCIL, 0xffffff00, 1.0f, 0xffff));	// 0xffffffff
